...
using BWS.CMS.Headless.Api.Data;
using BWS.CMS.Headless.Api.Repositories;

namespace BWS.CMS.Headless.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "BWS.CMS.Headless.Api");
                });
